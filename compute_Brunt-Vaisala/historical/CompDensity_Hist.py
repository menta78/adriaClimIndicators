...
path = '/Volumes/alessandri/AdriaClim_Data/erddap.cmcc-opa.eu/erddap/files/adriaclim_resm_nemo_historical_day_T/'
...
#      print(single_date)
      ...
      # name of output file
      pathout = '/Volumes/alessandri/AdriaClim_Data/Historical_Nemo/Density/'
