...
path = '/Volumes/alessandri/AdriaClim_Data/Indicator/Projection_Nemo/Density/'

#--- start and end date ---#
start_date = date(2042,2,20)
end_date = date(2042,3,10)
...
#      print(single_date)
      ...
      # name of output file
      pathout = '/Volumes/alessandri/AdriaClim_Data/Indicator/Projection_Nemo/Brunt-Vaisala/'
