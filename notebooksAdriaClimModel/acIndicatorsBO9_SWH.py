...
pltRange = [0, 1.3]
annualPlot = acIndWavesGraphicUtils.plotMeanMap(tmpAnnualNcFileSpec, "Mean Annual SWH (m)", pltRange)
plt.savefig(f'annualMap{indicatorName}.png', dpi=200)
winterPlot = acIndWavesGraphicUtils.plotMeanMap(tmpWinterNcFileSpec, "Mean Winter SWH (m)", pltRange)
plt.savefig(f'winterMap{indicatorName}.png', dpi=200)
summerPlot = acIndWavesGraphicUtils.plotMeanMap(tmpSummerNcFileSpec, "Mean Summer SWH (m)", pltRange)
